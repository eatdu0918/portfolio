...
[Phone] · [Email] · [City, Country — optional]  
GitHub: [URL] · Portfolio: [URL] · Blog: [URL — optional] · LinkedIn: [URL — optional]

---

## Summary

Full-stack engineer focused on **Vue 3 and React/Next.js** frontends, **Spring Boot** services, and **AI inference integration** (queues, workers, desktop clients). Shipped **large-scale 2D/3D geospatial UIs** (OpenLayers, Cesium), **tactical symbol rendering (MIL-STD-2525D)**, and **real-time features** (WebSocket/STOMP, Redis Pub/Sub, RabbitMQ). Built a **video/image de-identification SaaS** with Vue + Electron, Spring multi-modules, and multiple model backends. Outside work: **Next.js App Router** blog (unified markdown pipeline, Prisma, PostgreSQL) and an **e-commerce MSA** lab (Spring Cloud Gateway, Kafka, Kubernetes, GitHub Actions).
...
- **Military:** *[if applicable / per local norms]*

---

## Skills *(compressed)*

- **Frontend:** Vue 3, Nuxt, React 19, Next.js, TypeScript, Electron, Pinia, Tailwind CSS, PrimeVue, Quasar  
- **Backend:** Spring Boot 3, Spring Cloud, Spring Security/JWT, REST, MyBatis, Kafka, RabbitMQ, WebSocket  
- **GIS:** OpenLayers, Cesium, MIL-STD-2525D, Turf.js  
- **Data:** PostgreSQL, MySQL/MariaDB, MongoDB, Redis, Prisma  
- **AI/ML integration:** Python, YOLOv8, Stable Diffusion, OpenCV  
- **DevOps:** Docker, Kubernetes, Nginx, Prometheus, Git, CI/CD (GitHub Actions)

---

## Notes for big-tech / overseas applications

- Keep to **one page** when exporting to PDF; trim oldest project bullets if needed.  
- Add **metrics** only when verifiable (latency, traffic, team size, etc.).  
- Align job titles with **employer records** for background checks.

---
title: "AETEM - AI 기반 군사 지휘통제 시스템"
slug: "aetem"
summary: "Cesium 3D 지도 기반의 군사 작전 지휘통제 플랫폼. 국면/부대/무기/환경 관리, AI 이동로/타격범위 분석, 엣지 장비(드론/LiDAR) 연동, 실시간 WebSocket 상황 공유까지 지원하는 C4I 시스템입니다."
period: "2024.06 - 2025.03"
role: "풀스택 개발"
thumbnail: "/images/projects/aetem/thumbnail.png"
...
techStack:
  ...
  ai: ["이동로 분석 API (GeoTools/JTS)", "타격범위 분석 API (GeoTIFF)", "MGRS 군사좌표", "proj4 좌표변환"]
highlights:
  - "Cesium 3D 지도 기반 실시간 작전 상황판 구현 (부대 배치, 기동로, 타격범위 시각화)"
  - "AI 이동로 분석 및 타격범위 분석 모델 API 연동 (비동기 콜백 패턴)"
...
AETEM은 AI 기술을 접목한 군사 작전 지휘통제(C4I) 시스템입니다. 지휘관이 3D 지도에서 작전 상황을 실시간으로 파악하고, AI 분석 결과를 기반으로 의사결정을 지원받을 수 있는 플랫폼입니다.
...
- **AI 분석 연동**: 이동로 최적경로 분석, 타격범위(GeoTIFF) 분석 결과를 3D 지도에 오버레이
...
3개 Vue 3 클라이언트와 Spring Boot 3 백엔드 API 전 영역의 풀스택 개발을 담당했습니다. Cesium 3D 지도 통합, AI 모델 API 연동, WebSocket 실시간 통신, 엣지 장비 연동까지 시스템 전반에 걸쳐 개발했습니다.

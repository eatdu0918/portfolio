...
- **아키텍처**: 모듈·큐·하이브리드 저장소
- **프론트엔드**: Tiles 레이아웃 분리, 플러그인 도구 JS 구조
- **백엔드**: API·Consumer·플러그인 서비스 응집도

## 나의 역할

**JSP 프론트, Spring API, RabbitMQ Consumer, 공통 라이브러리**까지 풀스택으로 파이프라인을 주도했다. “플러그인을 어떻게 안전하게 조합할지”에 초점을 맞췄다.

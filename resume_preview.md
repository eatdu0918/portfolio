...
웹 풀스택 개발자 · 경력 약 2년 3개월

+------------------------+----------------------------------------+
| 📧 eatdu0918\@gmail.com | 🔗 GitHub: https://github.com/eatdu0918 |
|                        |                                        |
| 📱 010-8310-1753        | 🌐 포트폴리오: \[포트폴리오 URL\]       |
+------------------------+----------------------------------------+
...
**AETEM --- AI 기술 접목 군사 지휘통제(C4I)** 2024.06 \~ 2025.03
...
**Sparta e-commerce MSA --- 이커머스 마이크로서비스** 2025.01 \~ 2025.02

*개인 프로젝트 (팀스파르타 교육 과정 최종 과제)*
...
> **🎓 교육 및 자격**
  ...
  **기간**             **학교 / 과정명**                            **학위 / 구분**   **상태**
  ...
  2022.03 \~ 2022.12   더좋은아카데미학원 - Java기반 웹 개발 교육   수료              수료
